...
Files: macbook-16.glb [639.28KB] > C:\College-SEM4\INM420-WebDev\macbook-gsap\public\models\macbook-16-transformed.glb [629.72KB] (1%)
...
export default function MacbookModel16(props) {
    ...
    // Fixed: Added closing brace for useEffect
    useEffect(() => {
    ...
    }, [color]);  // ✅ Added closing brace and dependency array

    return (  // ✅ Return is now outside useEffect
